  ...
  return(
    <nav className="h-20 flex border-b justify-between font-medium bg-white">
      <Link href="/" className="pl-6 flex items-center">
        <span className={cn("text-5xl font-medium", poppins.className)}>
          funroad
        </span>
      </Link>
      ...
      <div className="hidden lg:flex">
        <Button asChild variant={'secondary'} className="border-l border-t-0 border-r-0 px-12 h-full rounded-none
         bg-white hover:bg-pink-400 transition-colors text-lg">
          <Link href={"/sign-in"}>
          Sign in
          </Link>
        </Button>
        <Button asChild className="border-l border-t-0 border-r-0 px-12 h-full rounded-none
